...
const CssIcon = ({ width, name }: CssIconProps) => {
  return (
    <div className="flex flex-col items-center group group-hover:transition-all duration-300">
      ...
      >
        <path
          ...
          fill="#fff"
          className="group-hover:fill-[#1b73ba] transition-colors duration-300"
        />
        <path
          d="M62.468 129.275V12.085l51.064.17-9.106 104.85z"
          fill="#fff"
          className="group-hover:fill-[#1c88c7] transition-colors duration-300"
        />
        <path
